<div class="cellier">
    ...
    <div class="cellier__page-top">
        <div class="boutons__figures-cellier">
...
<div class="gallerie portail">
    ...
    ?>
            <script>
                var id = <?php echo json_encode($_SESSION['cellier_id']); ?>
            </script>
                                ...
                                <div class="carte__details-row">
                                    ...
                                    <?php if (!empty($bouteille['url_saq'])) { ?>
                                        ...
                                        <?php
                                            ...
                                            <img src="./assets/img/site_img/vin_perso_.png" style="width: 3em; margin-bottom: 10px;" alt="vin personnel vino etu">
                                    <?php
